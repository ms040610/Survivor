Airforce
스크린샷 2024-04-13 오전 12 35 56
...
5. 게임 오버
⛰️ Challenges
1. Phaser 3 프레임워크 채택 이유
1.1 웹 게임은 어떻게 만들 수 있을까?
1.2 WebGL vs CanvasAPI
1.3 Phaser를 사용해보자!
2. 무한 맵 구현하기
2.1 맵은 얼마나 커야 할까?
...
2. 무한 맵 구현하기
제 프로젝트에서의 맵은 플레이가 진행되는 공간을 의미합니다. 플레이가 이루어지는 공간은 크기, 확장 여부 등 그 성질에 따라 매우 다른 게임적 특성을 지니기에, 제가 구현하고자 하는 게임에 걸맞는 특성을 우선 정의해야 했습니다.
...
스크린샷 2024-05-22 오후 6 22 16
2.2.2 임계치 좌표 설정 후 맵을 이어 붙이기
...
스크린샷 2024-05-22 오후 6 29 06
2.2.3 플레이어 이동 방향으로 맵 에셋의 좌표 이동
...
스크린샷 2024-05-24 오전 10 36 24
2.3 착시를 이용한 무한 맵 구현을 해보자!
...
스크린샷 2024-05-22 오후 6 41 36
3.2.2 완전 랜덤 위치
...
스크린샷 2024-05-22 오후 6 44 39
3.2.3 일정 거리 이상 랜덤 위치
...
스크린샷 2024-05-15 오후 7 38 58
3.3 일정 거리 이상 랜덤 위치에서 등장하게 해보자!
